...
export const furnitureCases: FurnitureCase[] = [
  {
    ...
    scene: '卧室空间',
    material: '天然实木',
    summary: '保留原网站家具定制素材，用于展示床架尺寸、木材、结构与家庭空间适配方案。',
    tags: ['床架', '卧室', '实木'],
  },
  {
    ...
    scene: '餐厅与工作区',
    material: '实木板材',
    summary: '适合承接餐桌、工作桌和亲子活动桌需求，后续接入尺寸选择与报价接口。',
    tags: ['桌类', '餐厅', '工作区'],
  },
  {
    slug: 'kids-play-bed',
    ...
    scene: '儿童房',
    material: '实木结构',
    summary: '结合床架、秋千与活动空间，展示儿童家具定制的结构安全与场景设计。',
    tags: ['儿童房', '活动床', '安全结构'],
  },
  {
    ...
    scene: '床边收纳',
    material: '实木框架',
    summary: '用于展示小型家具、床边收纳与空间补充件，后续可接入案例详情与咨询记录。',
    tags: ['边几', '收纳', '小型家具'],
  },
];
