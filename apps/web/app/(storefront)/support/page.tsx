...
export async function generateMetadata() {
  ...
  return { title: t("Support & Downloads") };
}
...
type Faq = { id: string; title: string; sections: unknown };
...
export default async function SupportPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      <h1 className="text-3xl font-bold">{t("Support & Downloads")}</h1>
      ...
      <section className="mt-10">
        ...
        {downloads.length ? (
          ...
          <p className="mt-4 rounded-2xl bg-neutral-50 p-6 text-sm text-neutral-500">
            {t("No public downloads have been published yet.")}
          </p>
        )}
      </section>
