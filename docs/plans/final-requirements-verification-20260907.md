...
> 最新功能版本 `4fe2169` 的 CI #51 全部通过：110 单测、169 DB/邮件、70 浏览器/性能及生产扫描/恢复。当前需求 v0.5、测试 v0.7、100 用户实测和材料状态见[提交索引](../deliverables/README.md)。下文历史阶段的排除或待 CI 说明不覆盖后续已完成工作。
