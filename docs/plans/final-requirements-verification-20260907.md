...
> 最新功能版本 `f3c074f` 的 CI #54 全部通过：110 单测、169 DB/邮件、70 浏览器/性能及生产扫描/恢复。当前需求 v0.5、测试 v0.7、100 用户实测和材料状态见[提交索引](../deliverables/README.md)。课程工作量采用组长确认的甘文韬 25%、其余四人各 18.75%，不按实际工时重新折算。下文历史阶段的课程排除、计划占比或待 CI 说明不覆盖后续更新。
